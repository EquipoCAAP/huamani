...
namespace sb_admin.web.Controllers
{
    public class tipo_juzgadoController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "id,tipo_juzgado1")] tipo_juzgado tipo_juzgado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "id,tipo_juzgado1")] tipo_juzgado tipo_juzgado)
        {
            if (ModelState.IsValid)
            {
